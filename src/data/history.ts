...
export const TIMELINE: TimelineEntry[] = [
  ...
  { year: '1948', title: 'La Nakba — "la catástrofe"', body: 'Más de 750.000 palestinas y palestinos expulsados; 530 aldeas destruidas. El 90% de la población árabe es desplazada del territorio que se convierte en Israel.', tags: ['Nakba', 'Despojo'], major: true }, // Fuente: 418 aldeas rurales (Khalidi, All That Remains, 1992) + 113 comunidades beduinas del Naqab (Abu Sitta, Atlas of Palestine, 2010). Consenso >750.000 refugiados (PASSIA, 2023).
